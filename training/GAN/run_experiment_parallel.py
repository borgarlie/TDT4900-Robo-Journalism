...
from training.GAN.train_parallel import train_GAN_parallel
...
if __name__ == '__main__':
    ...
    # TODO: test. still getting the error
    # generator_decoder.gru.flatten_parameters()
    ...
    # Sharing decoder across processes
    generator_decoder.share_memory()
    ...
    train_GAN_parallel(config, generator, discriminator, train_articles, test_articles, max_article_length,
                       max_abstract_length, writer, device_number)
